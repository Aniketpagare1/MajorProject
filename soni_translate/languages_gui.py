...
language_data = {
    "english": {
        ...
        Let's start having fun with video translation! 🚀🎉
        """,
        "tutorial": """
        ...
        # 🧩 **We have different TTS (Text-to-Speech) engines, which are:**
    ...
    "spanish": {
        "description": """
        ### 🎥 **¡Traduce videos fácilmente con ** 📽️

        Sube un video, audio o proporciona un enlace de YouTube.**
        ...
        # 🧩 **admite diferentes motores de TTS (Texto a Voz), los cuales son:**
    ...
    "french": {
        "description": """
        ### 🎥 **Traduisez facilement les vidéos** 📽️

        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel**
        ...
        # 🧩 **prend en charge différents moteurs TTS (Text-to-Speech), à savoir :**
    ...
    "german": {
        "description": """
        ### 🎥 **Übersetzen Sie Videos einfach mit ** 📽️

        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **
        ...
        # 🧩 **unterstützt verschiedene TTS (Text-to-Speech)-Engines, darunter:**
    ...
    "italian": {
        ...
        Carica un video, un file audio o fornisci un link YouTube. **
    ...
    "hindi": {
        "description": """
          ### 🎥 ** वीडियो को आसानी से अनुवादित करें!** 📽️

          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **
        ...
        "tutorial": """
          ...
          # 🧩 **विभिन्न TTS (टेक्स्ट-टू-स्पीच) इंजनों का समर्थन है, जो हैं:**
    ...
    "marathi": {
        "description": """
        ### 🎥 **आसानीसोबत व्हिडिओ अनुवाद करा!** 📽️

        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️**
        ...
        # 🧩 **विविध TTS (पाठ-टू-स्पीच) इंजिनसाठी समर्थन करते, ज्या म्हणजे:**
